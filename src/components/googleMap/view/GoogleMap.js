...
import AutoComplete from "../../travel/view/AutoComplete";
   ...
   const scrollAnimate = (value) => {
      ...
      markers[index].type == "location"
         ...
         : (pos = {
              ...
              latitudeDelta:
                 Math.abs(
                    markers[index].startPoint.latitude -
                       markers[index].endPoint.latitude
                 ) * 3,
              longitudeDelta:
                 Math.abs(
                    markers[index].startPoint.longitude -
                       markers[index].endPoint.longitude
                 ) * 3,
           });
